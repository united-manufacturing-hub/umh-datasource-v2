...
export function getDemoTimeseriesData(query: FactoryinsightQuery, from: number, to: number): MutableDataFrame {
  ...
  if (isTag) {
      ...
      aggregates.forEach((aggregate) => {
        switch (aggregate) {
          ...
          case 'min':
            data.add({
              Time: i,
              min: avg - Math.random() * 5,
            });
            break;
          case 'max':
            data.add({
              Time: i,
              max: avg + Math.random() * 5,
            });
            break;
          case 'count':
            data.add({
          ...
          case 'sum':
            data.add({
              Time: i,
              sum: avg * Math.floor(Math.random() * 100),
            });
            break;
        }
      });
    ...
    data.addField({
      name: 'Begin',
      values: [
        1606089943000, 1606094730000, 1606243321000, 1606255888000, 1606265579000, 1606269189000, 1606330275000,
        1606340592000, 1606352142000, 1606357912000, 1606362037000, 1606407827000,
      ],
      type: FieldType.time,
    });
    ...
    data.addField({
      name: 'End',
      values: [
        1606094711000, 1606100771000, 1606253181000, 1606265565000, 1606267349000, 1606279029000, 1606332283000,
        1606348944000, 1606357896000, 1606360297000, 1606367208000, 1606416662000,
      ],
      type: FieldType.time,
    });
    ...
    data.addField({
      ...
      values: [4768, 6041, 9860, 9677, 1770, 9840, 2008, 8352, 5754, 2385, 5171, 8835],
      type: FieldType.number,
    });
    ...
    data.addField({
      name: 'Producing',
      values: [2199, 1446, 6197, 4665, 1233, 5825, 1001, 2599, 2370, 1337, 2840, 5836],
      type: FieldType.number,
    });
    return data;
  }
